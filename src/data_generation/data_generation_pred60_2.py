...
def main():
    ...
    # Prepare LSTM training data (including all anomaly types)
    X_lstm = X_scaled
    y_lstm_int = y_codes
    # One-hot encode all four classes: none (0), anaphylaxis (1), malignant_hyperthermia (2), respiratory_depression (3)
    y_lstm = to_categorical(y_lstm_int, num_classes=len(TYPE_TO_CODE))
