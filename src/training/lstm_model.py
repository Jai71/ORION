...
from src.common import f1_m  # noqa: E402
...
if __name__ == '__main__':
    ...
    parser.add_argument('--x_train',        type=str,   default=resolve('data/processed/X_train.npy'),      help='Path to X_train NumPy file')
    parser.add_argument('--y_train',        type=str,   default=resolve('data/processed/y_train.npy'),      help='Path to y_train (one-hot) NumPy file')
    parser.add_argument('--checkpoint',     type=str,   default=resolve('checkpoints/best_lstm.h5'), help='Path to save best model checkpoint')
    parser.add_argument('--output_model',   type=str,   default=resolve('models/final_lstm.h5'), help='Path to save the final model')
    parser.add_argument('--log_dir',        type=str,   default=resolve('logs/fit'),        help='TensorBoard log directory')
