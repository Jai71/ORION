...
MODEL_REGISTRY = {
    "lstm_bi": {
        ...
        "scaler_path": str(DATA_DIR / "scaler_train.joblib"),
    ...
    "forecast": {
        ...
        "scaler_path": str(DATA_DIR / "scaler_pred_train.joblib"),
    ...
    "forecast30": {
        ...
        "scaler_path": str(DATA_DIR / "scaler_pred30_train.joblib"),
        "labels": ["none", "anaphylaxis", "malignant_hyperthermia"],
        "has_attention": True,
    },
    "pretrain": {
        ...
        "scaler_path": str(DATA_DIR / "scaler_pretrain_train.joblib"),
        "labels": ["none", "anaphylaxis", "malignant_hyperthermia", "respiratory_depression"],
        "has_attention": True,
    },
}
